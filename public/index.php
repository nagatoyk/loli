...
$sql2 = "CREATE TABLE IF NOT EXISTS `imouto_category` (`id` int(11) NOT NULL AUTO_INCREMENT,`icon` varchar(30) NOT NULL,`name` varchar(60) NOT NULL,`des` text NOT NULL,PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;";
$sql3 = "CREATE TABLE IF NOT EXISTS `imouto_core_attachment` (`id` int(11) NOT NULL AUTO_INCREMENT,`name` varchar(60) NOT NULL,`filename` varchar(255) NOT NULL,`path` varchar(255) NOT NULL,`extension` varchar(5) NOT NULL,`size` int(11) NOT NULL,`hash` varchar(64) NOT NULL,`data` text NOT NULL,PRIMARY KEY (`id`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;";
$sql4 = "CREATE TABLE IF NOT EXISTS `imouto_link` (`id` int(11) NOT NULL AUTO_INCREMENT,`icon` varchar(30) NOT NULL,`name` varchar(60) NOT NULL,`url` varchar(60) NOT NULL,`des` text NOT NULL,PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;";
