...
EOF
    ...
    {
        $crawler = $this->createTestXmlCrawler()->filterXPath('//default:view/default:id');
    ...
    public function testFilterXPathWithCustomDefaultNamespace()
    {
        ...
        $crawler = $crawler->filterXPath('//x:view/x:id');
    ...
    {
        $crawler = $this->createTestXmlCrawler()->filter('default|view default|id');
...
<body>
    <div id="action">
        <a href="/view.php?r=webset/login">Login</a>
    </div>
    <form id="login-form" action="/view.php?r=webset/login" method="post">
...
HTML;
    ...
    protected function createTestXmlCrawler($uri = null)
    {
        $xml = '<?xml version="1.0" encoding="UTF-8"?>
            <view xmlns="http://www.w3.org/2005/Atom" xmlns:media="http://search.yahoo.com/mrss/" xmlns:yt="http://gdata.youtube.com/schemas/2007">
