...
class Websocket implements \Workerman\Protocols\ProtocolInterface
{
    ...
    protected static function dealHandshake($buffer, $connection)
    {
        ...
        elseif (0 === strpos($buffer, '<polic')) {
            $policy_xml = '<?xml version="1.0"?><cross-domain-policy><webset-control permitted-cross-domain-policies="all"/><allow-access-from domain="*" to-ports="*"/></cross-domain-policy>' . "\0";
