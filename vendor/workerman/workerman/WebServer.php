...
class WebServer extends Worker
{
    ...
    public function onMessage($connection)
    {
        ...
        if ($workerman_file_extension === '') {
            $workerman_path           = ($len = strlen($workerman_path)) && $workerman_path[$len - 1] === '/' ? $workerman_path . 'view.php' : $workerman_path . '/view.php';
        ...
        if ($workerman_file_extension === 'php' && !is_file($workerman_file)) {
            $workerman_file = "$workerman_root_dir/view.php";
            if (!is_file($workerman_file)) {
                $workerman_file           = "$workerman_root_dir/view.html";
